# Olympia Gym — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-olympia-gym/
- **Repo:** `shreekantha3/sindagi-olympia-gym` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-olympia-gym/'` for GitHub Pages project-site hosting.
